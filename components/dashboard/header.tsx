...
export function DashboardHeader({
  ...
  return (
    <header className="sticky top-0 z-30 flex h-14 items-center justify-between gap-2 border-b border-border/50 bg-background/70 px-4 backdrop-blur-xl sm:px-6">
      <span
        aria-hidden="true"
